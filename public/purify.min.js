...
!(function (e, t) {
  ...
  function _(e, o, r) {
    var i
    ;(r = null !== (i = r) && void 0 !== i ? i : f), t && t(e, null)
    let a = o.length
    for (; a--; ) {
      let t = o[a]
      if ('string' == typeof t) {
  ...
  var V = (function t() {
    ...
    let { IS_ALLOWED_URI: pe } = X,
      fe = null
    const de = _({}, [...S, ...x, ...v, ...k, ...L])
    let he = null
    const ge = _({}, [...O, ...M, ...I, ...U])
    let ye = Object.seal(
        Object.create(null, {
    ...
    let Xe = qe,
      Ye = !1,
      Ke = null
    const Ve = _({}, [Ge, je, qe], d)
    let $e
    const Ze = ['application/xhtml+xml', 'text/html'],
      Je = 'text/html'
    let Qe,
      et = null
    const tt = a.createElement('form'),
      nt = function (e) {
      ...
      ot = function (e) {
        ;(et && et === e) ||
          ...
          (e = w(e)),
          ($e = $e =
            -1 === Ze.indexOf(e.PARSER_MEDIA_TYPE) ? Je : e.PARSER_MEDIA_TYPE),
          (Qe = 'application/xhtml+xml' === $e ? d : f),
          (fe = 'ALLOWED_TAGS' in e ? _({}, e.ALLOWED_TAGS, Qe) : de),
          (he = 'ALLOWED_ATTR' in e ? _({}, e.ALLOWED_ATTR, Qe) : ge),
          (Ke =
            'ALLOWED_NAMESPACES' in e ? _({}, e.ALLOWED_NAMESPACES, d) : Ve),
          (Be =
            'ADD_URI_SAFE_ATTR' in e ? _(w(We), e.ADD_URI_SAFE_ATTR, Qe) : We),
          (He =
            'ADD_DATA_URI_TAGS' in e ? _(w(ze), e.ADD_DATA_URI_TAGS, Qe) : ze),
          (Fe = 'FORBID_CONTENTS' in e ? _({}, e.FORBID_CONTENTS, Qe) : Pe),
          (Te = 'FORBID_TAGS' in e ? _({}, e.FORBID_TAGS, Qe) : {}),
          (Ee = 'FORBID_ATTR' in e ? _({}, e.FORBID_ATTR, Qe) : {}),
          ...
          Ue &&
            ((fe = _({}, [...L])),
            (he = []),
            !0 === Ue.html && (_(fe, S), _(he, O)),
            !0 === Ue.svg && (_(fe, x), _(he, M), _(he, U)),
            !0 === Ue.svgFilters && (_(fe, v), _(he, M), _(he, U)),
            !0 === Ue.mathMl && (_(fe, k), _(he, I), _(he, U))),
          e.ADD_TAGS && (fe === de && (fe = w(fe)), _(fe, e.ADD_TAGS, Qe)),
          e.ADD_ATTR && (he === ge && (he = w(he)), _(he, e.ADD_ATTR, Qe)),
          e.ADD_URI_SAFE_ATTR && _(Be, e.ADD_URI_SAFE_ATTR, Qe),
          e.FORBID_CONTENTS &&
            (Fe === Pe && (Fe = w(Fe)), _(Fe, e.FORBID_CONTENTS, Qe)),
          Me && (fe['#text'] = !0),
          Re && _(fe, ['html', 'head', 'body']),
          fe.table && (_(fe, ['tbody']), delete Te.tbody),
          i && i(e),
          (et = e))
      },
    ...
    const st = function (e) {
        ...
        return (
          ...
          (e.namespaceURI === je
            ...
            ? !(t.namespaceURI === je && !it[o]) &&
              !(t.namespaceURI === Ge && !rt[o]) &&
              !ct[n] &&
              (at[n] || !lt[n])
            : !('application/xhtml+xml' !== $e || !Ke[e.namespaceURI]))
        )
      },
      mt = function (e) {
      ...
      pt = function (e) {
        ...
        return (
          e &&
            n &&
            r.insertBefore(a.createTextNode(n), r.childNodes[0] || null),
          Xe === qe
            ? ne.call(t, Re ? 'html' : 'body')[0]
            : Re
            ? t.documentElement
            : r
        )
      ...
      yt = function (e) {
        ...
        const n = Qe(e.nodeName)
        if (
          (gt('uponSanitizeElement', e, { tagName: n, allowedTags: fe }),
          e.hasChildNodes() &&
          ...
          if (Me && !Fe[n]) {
            ...
            if (n && t) {
              for (let o = n.length - 1; o >= 0; --o)
                t.insertBefore(G(n[o], !0), j(e))
            }
          }
          return mt(e), !0
        }
        return e instanceof b && !st(e)
          ? (mt(e), !0)
          ...
          ? (we &&
              ...
              e.textContent !== t &&
                ...
                (e.textContent = t))),
            gt('afterSanitizeElements', e, null),
            !1)
          : (mt(e), !0)
      },
      Tt = function (e, t, n) {
      ...
      At = function (e) {
        ...
        for (i = a.length; i--; ) {
          ...
          if (
            ((n = 'value' === c ? t.value : T(t.value)),
            (r = Qe(c)),
            (l.attrName = r),
            (l.attrValue = n),
            (l.keepAttr = !0),
            (l.forceKeepAttr = void 0),
            gt('uponSanitizeAttribute', e, l),
            (n = l.attrValue),
            l.forceKeepAttr)
          )
            continue
          if ((ut(c, e), !l.keepAttr)) continue
          if (!_e && E(/\/>/i, n)) {
            ut(c, e)
            continue
          }
          we && ((n = g(n, ie, ' ')), (n = g(n, ae, ' ')), (n = g(n, le, ' ')))
          const m = Qe(e.nodeName)
          if (Tt(m, r, n)) {
            if (
              (!Le || ('id' !== r && 'name' !== r) || (ut(c, e), (n = Oe + n)),
              Z &&
                'object' == typeof z &&
      ...
      bt = function e(t) {
        let n
        const o = ft(t)
        for (gt('beforeSanitizeShadowDOM', t, null); (n = o.nextNode()); )
          gt('uponSanitizeShadowNode', n, null),
            yt(n) || (n.content instanceof l && e(n.content), At(n))
    ...
    return (
      (o.sanitize = function (e) {
        ...
        if (
          ((Ye = !e), Ye && (e = '\x3c!--\x3e'), 'string' != typeof e && !ht(e))
        ) {
        ...
        if (
          (Se || ot(c), (o.removed = []), 'string' == typeof e && (Ie = !1), Ie)
        ) {
          if (e.nodeName) {
          ...
          if (!ve && !we && !Re && -1 === e.indexOf('<'))
            return Z && ke ? Z.createHTML(e) : e
          if (((t = pt(e)), !t)) return ve ? null : ke ? J : ''
        }
        t && xe && mt(t.firstChild)
        const m = ft(Ie ? e : t)
        for (; (i = m.nextNode()); )
          yt(i) || (i.content instanceof l && bt(i.content), At(i))
        if (Ie) return e
        if (ve) {
          if (De)
          ...
          return (
            (he.shadowroot || he.shadowrootmod) && (a = oe.call(r, a, !0)), a
          )
        }
        let u = Re ? t.outerHTML : t.innerHTML
        return (
          Re &&
            fe['!doctype'] &&
            t.ownerDocument &&
            ...
            E(q, t.ownerDocument.doctype.name) &&
            (u = '<!DOCTYPE ' + t.ownerDocument.doctype.name + '>\n' + u),
          we && ((u = g(u, ie, ' ')), (u = g(u, ae, ' ')), (u = g(u, le, ' '))),
          Z && ke ? Z.createHTML(u) : u
        )
      }),
